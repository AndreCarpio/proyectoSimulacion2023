    ...
    <div class="col cotenedor-fieldset">
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="text" class="form-control input-grande" id="inptu_deudor_nombre" maxlength="100"
                    name="deudor_nombre_apellidos" value="{{ $deudor->nombre ?? '' }}">
            </div>
            <div class="col">
                <label for="deudor_ci" class="form-label">CI:</label>
                <input type="text" class="form-control input-mediano" id="deudor_ci" name="deudor_ci" maxlength="100"
                    value="{{ $deudor->ci ?? '' }}">
            </div>
            <div class="col">
                <label for="deudor_ci_extension" class="form-label">Extensión</label>
                <input type="text" class="form-control input-pequenio" maxlength="100"
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="number" min="0" class="form-control input-pequenio" id="deudor_edad"
                    oninput="validarInputNumber(event);" name="deudor_edad" value="{{ $deudor->edad ?? '' }}">
            </div>
            <div class="col">
                <label for="deudor_estado_civil" class="form-label">Estado civil:</label>
                <input type="text" class="form-control input-mediano" id="deudor_estado_civil" maxlength="100"
            ...
            <div class="col">
                ...
                <input type="text" class="form-control input-mediano" id="deudor_telefono" name="deudor_telefono"
                    maxlength="100" value="{{ $deudor->telefono ?? '' }}">
            </div>
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control input-grande" id="deudor_direccion" name="deudor_direccion"
                maxlength="200" value="{{ $deudor->direccion ?? '' }}">
        </div>
    </div>
    ...
    <div class="col cotenedor-fieldset">
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="text" class="form-control input-grande" id="codeudor_nombre" maxlength="100"
            ...
            <div class="col">
                ...
                <input type="text" class="form-control input-mediano" id="codeudor_ci" name="codeudor_ci"
                    maxlength="100" value="{{ $codeudor->ci ?? '' }}">
            </div>
            <div class="col">
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="number" min="0" class="form-control input-pequenio" id="codeudor_edad"
                    oninput="validarInputNumber(event);" name="codeudor_edad" value="{{ $codeudor->edad ?? '' }}">
            </div>
            <div class="col">
                <label for="codeudor_estado_civil" class="form-label">Estado civil:</label>
                <input type="text" class="form-control input-mediano" id="codeudor_estado_civil" maxlength="100"
                    name="codeudor_estado_civil" value="{{ $codeudor->estadoCivil ?? '' }}">
            </div>
            <div class="col">
                <label for="codeudor_telefono" class="form-label">Teléfono:</label>
                <input type="text" class="form-control input-mediano" id="codeudor_telefono" maxlength="100"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control input-grande" id="codeudor_direccion"name="codeudor_direccion"
                maxlength="200" value="{{ $codeudor->direccion ?? '' }}">
        </div>
    </div>
</div>
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="text" class="form-control input-grande" id="persona_juridica_razon_social"
                    maxlength="100" name="persona_juridica_razon_social"
            ...
            <div class="col">
                ...
                <input type="text" class="form-control input-mediano" id="deudor_ci" name="persona_juridica_nit"
                    maxlength="100" value="{{ $personaJuridica->nit ?? '' }}">
            </div>
            <div class="col">
                <label for="persona_juridica_" class="form-label">Sigla</label>
                <input type="text" class="form-control input-pequenio" id="persona_juridica_" maxlength="100"
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="text" class="form-control input-pequenio" id="persona_juridica_tipo_sociedad"
                    maxlength="100" name="persona_juridica_tipo_sociedad"
                    value="{{ $personaJuridica->tipoSociedad ?? '' }}">
            </div>
            <div class="col">
                ...
                <input type="text" class="form-control input-mediano" id="persona_juridica_representante"
                    maxlength="100" name="persona_juridica_representante"
                    value="{{ $personaJuridica->repreLegales ?? '' }}">
            </div>
        </div>
        <div class="mb-3">
            <label for="persona_juridica_domicilio" class="form-label"> Domicilio Legal :</label>
            <input type="text" class="form-control input-grande" id="persona_juridica_domicilio" maxlength="200"
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="text" class="form-control input-pequenio" id="emprendimiento_departamento"
                    maxlength="100" name="emprendimiento_departamento"
                    value="{{ $emprendimiento->departamento ?? '' }}">
            </div>
            <div class="col">
                ...
                <input type="text" class="form-control input-mediano" id="emprendimiento_municipio"
                    maxlength="100" name="emprendimiento_municipio" value="{{ $emprendimiento->municipio ?? '' }}">
            </div>
            <div class="col">
                ...
                <input type="text" class="form-control input-mediano" id="emprendimiento_telefono"
                    maxlength="100" name="emprendimiento_telefono" value="{{ $emprendimiento->telefono ?? '' }}">
            </div>
        </div>
        <div class="mb-3">
            <label for="emprendimiento_direccion" class="form-label">Dirección del Emprendimiento:</label>
            <input type="text" class="form-control input-grande" id="emprendimiento_direccion" maxlength="200"
...
<div class="mb-3">
        ...
        <tbody class="body-table-descripcion-producto-servico">
            ...
            @foreach ($descripcionProductoServicio as $item)
                <tr class="fila-descripcion-producto-servico">
                    ...
                    <td>
                        <textarea maxlength="500" spellcheck="false" class="nombre-producto-servico form-control" rows="4">{{ $item->nombre }}</textarea>
                    </td>
                    <td>
                        <textarea maxlength="500" spellcheck="false" class="proceso-elaboracion form-control" rows="4">{{ $item->proceso }}</textarea>
                    </td>
                    <td>
                        <textarea maxlength="500" spellcheck="false" class="caracteristicas form-control" rows="4">{{ $item->caracteristicas }}</textarea>
                    </td>

                    <td style="text-align: center; vertical-align: middle;">
                        <button onclick="eliminarFilaDescripcionProductoServicio(this);" type="button"
                            id="" class="btn btn-danger btn-eliminar-descripcion-producto-servico">
    ...
    <div style="width: 100%; display: flex">
        <button type="button"
            class="btn btn-primary btn-agregar-tabla-tipo1 btn-agregar-descripcion-producto-servico"
            onclick="agregarFilaDescripcionProductoServicio();">
