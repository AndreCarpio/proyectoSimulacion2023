    ...
    <div class="col cotenedor-fieldset">
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="number" min="0" class="form-control input-pequenio" id="deudor_edad" name="deudor_edad"
                    value="{{ $deudor->edad ?? '' }}">
            </div>
            <div class="col">
    ...
    <div class="col cotenedor-fieldset">
        ...
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input type="number" min="0" class="form-control input-pequenio" id="codeudor_edad" name="codeudor_edad"
                    value="{{ $codeudor->edad ?? '' }}">
            </div>
            <div class="col">
    ...
    <div class="col cotenedor-fieldset">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col">
                ...
                <input type="text" class="form-control input-mediano" id="deudor_ci" name="persona_juridica_nit" value = "{{$personaJuridica ->nit ?? ''}}">
            </div>
            <div class="col">
...
<div class="mb-3">
    ...
    <table class="table">
        <thead>
            <tr>
                <th class="titulo-tabla-tipo1" scope="col">#</th>
        ...
        <tbody class="body-table-descripcion-producto-servico">
            ...
            @foreach ($descripcionProductoServicio as $item)
                ...
                <tr class="fila-descripcion-producto-servico">
                    <th class="numeracion" style="text-align: center; vertical-align: middle;" scope="row">{{$i}}</th>
                    <td>
                    ...
                    <td style="text-align: center; vertical-align: middle;">
                        <button onclick="eliminarFilaTablaTipo1(this)" type="text" id=""
    ...
    <div style="width: 100%; display: flex">
        <button type="button"
            class="btn btn-primary btn-agregar-tabla-tipo1 btn-agregar-descripcion-producto-servico"><i
