...
<div class="mb-3">
    ...
    <table class="table">
        ...
        <tbody class="body-table-descripcion-producto-servico">
            ...
            <tr class="fila-descripcion-producto-servico">
                <th class="numeracion" style="text-align: center; vertical-align: middle;" scope="row">1</th>
                <td>
    ...
    <div style="width: 100%; display: flex">
        <button class="btn btn-primary btn-agregar-tabla-tipo1 btn-agregar-descripcion-producto-servico"><i
